...
def iniciar_cliente(ip_servidor, puerto):
    ...
    hilo = threading.Thread(target = escuchar_servidor, args = (socket_cliente,), daemon=True) #Un hilo daemon es un hilo “secundario” que no impide que el programa termine.
    hilo.start()
